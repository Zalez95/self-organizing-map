...
global RUTA_FICHERO1	= '../data/distancias_entrenamiento.csv';
global RUTA_FICHERO2	= '../data/distancias_test.csv';
...
%%%% Obtenemos los datos %%%%
m_input = dlmread('../data/digitos_entrena_normalizados.txt');
...
% Fichero de test
m_input = dlmread('../data/digitos_test_normalizados.txt');
